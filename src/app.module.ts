...
@Module({
  imports: [  RegionModule, DebterModule, DebtModule, PrismaModule, SellersModule, MulterModule , TermsModule, JwtModule.register({
    ...
    }), JwtModule, AuthModule, AdminModule, ImagesDebtModule, ImagesClientModule, PayDebtModule, PaymentsModule, ExampleMessagesModule, FaqModule, ChatModule, CommonModule,],
